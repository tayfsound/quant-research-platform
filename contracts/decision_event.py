...
class DecisionEvent(BaseModel):
    ...
    # Faz 375 — multi-timeframe cascade instrumentation. Cascade Faz 457'de
    # mimariden KALDIRILDI, bu yüzden bu iki alan artık YENİ kararlarda hiç
    # doldurulmuyor (hep None). Kasıtlı olarak duruyorlar: decisions
    # tablosundaki mtf_direction/mtf_confidence sütunlarında GEÇMİŞ veri
    # var ve analiz gatherer'ları onu hâlâ okuyor — sözleşmeyi kaldırmak
    # o geçmişi okunamaz hale getirirdi.
