  ...
  return (
    <div>
      ...
      {/* Faz 392 — kullanıcı isteği (2026-08-31): Karar Kapısı'nın
          ...
          EV yüzünden WAIT'e dönecek bir karar, kapı uygun (FDR + zamanla
          tekrar + yeterli bağımsız N) bir grupla eşleşirse ZORLA açılıyor
          (küçültülmüş boyutla, izole deneysel kovada). Varsayılan KAPALI.
          Faz 392 düzeltme (aynı gün) — kullanıcı itirazı: "Onların
          güvenilmez olduklarına ne kadar eminiz? ... aynı hayatı yüz defa
          yaparım ki hata olduğuna emin olabileyim." Ayrı bir win_rate
          eşiği YOK — yukarıdaki Karar Kapısı'nın eşiğini paylaşır: kapı
          KAPALIYSA win_rate hiç filtrelenmez (sadece kapı uygunluğu
          yeterli), AÇIKSA aynı eşiği kullanır. */}
      <Card className="mb-6">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-xs text-ink-soft">
              ...
              bağımsız N) bir grupla eşleşirse yine de açılır — küçültülmüş boyutla (proposed_size × 0.5), ayrı bir
              deneysel kovada (agent_combo_force_open_v1, ana istatistikleri kirletmez). Win_rate eşiği YUKARIDAKİ
              Karar Kapısı ile paylaşılır: kapı kapalıyken win_rate hiç filtrelenmez, açıkken aynı eşiği kullanır.
              Kendi kill switch'i var: son 3 kapanmış işlemi art arda zararlıysa otomatik durur.
            </p>
          </div>
          <div className="flex items-center gap-2 shrink-0">
            <Button
