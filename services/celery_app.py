...
celery_app.conf.beat_schedule = {
    ...
    # Faz 331 — Agent Combination Reliability: hangi ajan İKİLİLERİNİN
    # birlikte anlaştığı win_rate ile ilişkili (Opportunity Quality'nin
    # "kaç ajan anlaştı" sorusunun tamamlayıcısı).
    "refresh-agent-combination-reliability-report-weekly": {
