...
EFFECT_SYMBOLS = [
    ...
    "HYPEUSDT", "ENAUSDT", "TAOUSDT", "XMRUSDT", "FETUSDT", "JTOUSDT",
    "DASHUSDT", "AEROUSDT", "PYTHUSDT", "COMPUSDT", "STRKUSDT", "MINAUSDT",
    "SNXUSDT", "KAVAUSDT", "DYDXUSDT", "GRTUSDT", "IOTAUSDT", "BATUSDT",
    "EGLDUSDT", "ZILUSDT", "ARKMUSDT", "MANAUSDT", "NEOUSDT", "ENJUSDT",
    "XTZUSDT", "TRUMPUSDT", "FARTCOINUSDT", "1000PEPEUSDT", "PENGUUSDT",
    "MOVRUSDT", "WIFUSDT", "1000SHIBUSDT", "1000BONKUSDT", "1000FLOKIUSDT",
    "NVDAUSDT", "XAGUSDT", "QQQUSDT", "SPXUSDT",
]
BARS = 200
MAX_LAG = 5
